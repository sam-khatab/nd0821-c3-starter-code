...
def process_data(
    ...
    Removed training as input... enter None for encoder to retrain
    categorical features and label binarizer. Enter trained encoder
    to re-use the one-hot encoder and label binarizer.
    ...
    if no label given data is only features, otherwise separate
    features and labels
    """
